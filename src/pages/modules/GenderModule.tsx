    ...
    <AppLayout>
      ...
      >
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
          <div className="flex-1">
            <h3 className="text-lg font-semibold">Latest Job Opportunities</h3>
            <p className="text-sm text-muted-foreground mt-1">
              12 new jobs available in your area. Skills in handicrafts and textile are in demand.
            </p>
          </div>
          ...
          <div className={`h-40 w-full md:w-1/2 flex items-center justify-center bg-${module.color}/5 rounded-lg border border-${module.color}/20`}>
            <Users className={`h-6 w-6 text-${module.color} opacity-60`} />
            <p className="text-sm text-muted-foreground ml-2">Job listings will appear here</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <p className="text-sm text-muted-foreground">
          Job opportunities updated daily. Skills courses available offline.
        </p>
      </motion.div>
    </AppLayout>
  );
