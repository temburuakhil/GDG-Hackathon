      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {module.features.map((feature, index) => (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.1 + (index * 0.1), ease: [0.22, 1, 0.36, 1] }}
            className={`glass p-6 rounded-xl border-l-4 border-water hover-lift`}
          >
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Recent water quality metrics from your area show normal levels.
            </p>
          </div>
          
          <div className="h-40 w-full md:w-1/2 flex items-center justify-center bg-water/5 rounded-lg border border-water/20">
            <BarChart className="h-6 w-6 text-water opacity-60" />
